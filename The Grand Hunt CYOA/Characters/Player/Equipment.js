...
function displayEquipment (from) {
  if (from == 'store') {
    ...
    if ($('#inventory').hasClass('hidden')) {
      ...
      $('<p class=\'texts E\'>Equipment</p>').appendTo('#equipment');
...
$(document).on('click', '.c-buttons', function () {
  ...
  if (button == 'i-equipment') {
    ...
    /* else if (hand1 != "fist" && hand2 == "fist") { // keeping this around in case player decide to grow more arms, hopeful by then, you will have easier means to do this than to check for every arms...
