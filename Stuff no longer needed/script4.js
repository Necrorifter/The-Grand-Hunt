  ...
  $(document).on('click', '.command_button', function () {
    ...
    function Blank () {
      if (originmode == true && blankobg == false && bountyhunterobg == false && mercenaryobg == false) {
        ...
        const bo1 = $("<p>I don't really remember why I am here, but I can tell that this is my chance for new life. But even if you don't remember why you are here... surely, you must remember your own name, right?</p>") // blank origin 1
    ...
    function BountyHunter () {
      if (originmode == true && blankobg == false && bountyhunterobg == false && mercenaryobg == false) {
        ...
        const bho1 = $('<p>I came here with my gang to get rich!</p>').insertBefore('#placeholder')
        $(bho1)
        $('.command_button').fadeOut(0)
        $('#Intro').fadeOut(0)
        $('.command_line').insertBefore('#placeholder').fadeIn(0)
    ...
    function Mercenary () {
      if (originmode == true && blankobg == false && bountyhunterobg == false && mercenaryobg == false) {
        mercenaryobg = true
        const mo1 = $('<p>My boss want me to stay here and find something fancy and valuable and deliver it to him.</p>').insertBefore('#placeholder')
        $(mo1)
        $('.command_button').fadeOut(0)
        $('#Intro').fadeOut(0)
        $('.command_line').insertBefore('#placeholder').fadeIn(0)
